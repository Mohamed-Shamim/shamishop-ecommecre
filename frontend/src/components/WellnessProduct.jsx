...
const WellnessProduct = () => {
    ...
    const [wellness, setLatestProduct] = useState([])
    ...
    useEffect(() => {
        const wellness = productData.filter((item) => (item.wellness === true))
        setLatestProduct(wellness)
    ...
    return (
        <div className='py-4 container' >
            <div className="items-start" >
                <h1 className='text-[20px] md:text-[24px] text-[#363636] font-semibold'> Wellness Product</h1>
            </div>
