        ...
        <div className="hidden lg:block no-scrollbar gap-2 mt-4 overflow-x-auto py-2">
          {product.image.map((img, index) => (
            <motion.div
              ...
              className={`flex-shrink-0 w-16 h-16 rounded-md overflow-hidden cursor-pointer border-2 mt-2 ${
                index === currentIndex
                  ? "border-blue-500"
                  : "border-transparent"
              }`}
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-4 items-center mt-2">
            <p className="text-sm text-black/40">
              Brands : <span className="text-black">{product.brands}</span>
            </p>
          ...
          <div className="flex flex-row items-center flex-wrap gap-3 mt-2">
            ...
            <h3 className="line-through text-gray-400 font-semibold text-[18px]">
              {currency}
              {product.offerPrice}.00
            </h3>
            <span className="text-gray-500 font-semibold flex gap-2 ">
              Available in Stock :{" "}
              <p className="text-[#0cae83]">{product.inStock}</p>
            </span>
          </div>
          <div className="mt-3">
          ...
          <div className="mt-4">
            <span className="text-[18px] font-semibold text-gray-700">
              Free Shopping (Est. Delivery Time 2-3 Days)
            </span>
          </div>
          ...
          <div className="flex items-center gap-4 mt-7  ">
            ...
            <button className="flex gap-2 items-center justify-center cursor-pointer">
              <img src={swap} alt="" className="h-6" /> Add to Compare
            </button>
          </div>
        </div>
              ...
              <form onSubmit={handleReviewSubmit}>
                ...
                <div className="mb-4">
                  <StarReviewsRating
                    ...
                    onHover={(hoverRating) =>
                      setReviewForm({ ...reviewForm, hoverRating })
                    }
                  />
                </div>
